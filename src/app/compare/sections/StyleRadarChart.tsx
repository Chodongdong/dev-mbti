...
import { COMPARE_COLORS } from "@/constants/colors";
        ...
        <CardContent>
          <div className="flex justify-center gap-6 mb-3 text-xs text-muted-foreground">
            <span className="flex items-center gap-1">
              <span className="inline-block w-3 h-0.5" style={{ backgroundColor: COMPARE_COLORS.userA }} />
              @{compareResult.userA.username}
            </span>
            <span className="flex items-center gap-1">
              <span className="inline-block w-3 h-0.5" style={{ backgroundColor: COMPARE_COLORS.userB }} />
          ...
          <ResponsiveContainer width="100%" height={260}>
            <RadarChart data={radarData}>
              ...
              <Radar name={compareResult.userA.username} dataKey="A" stroke={COMPARE_COLORS.userA} fill={COMPARE_COLORS.userA} fillOpacity={0.25} />
              <Radar name={compareResult.userB.username} dataKey="B" stroke={COMPARE_COLORS.userB} fill={COMPARE_COLORS.userB} fillOpacity={0.25} />
              <Tooltip />
            </RadarChart>
          </ResponsiveContainer>
        </CardContent>
